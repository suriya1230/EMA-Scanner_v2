...
GET /api/swing-zones — every coin >= min_volume_usdt (default $10M) with a
...
from app.services.swing_strategy import DEFAULT_CONFIRM_FROM, DEFAULT_MIN_VOLUME_USDT, scan_swing_zones
